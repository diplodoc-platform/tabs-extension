...
import {getName, getTabId, getTabKey, isTabSelected} from './utils/tabs';
import {RuntimeTab, TabsOrientation} from './types';
...
export function insertTabs(
    ...
    {start, end}: {start: number; end: number},
    {
        ...
        runId,
        orientation,
    }: {containerClasses: string; tabsGroup: string; runId: string; orientation: TabsOrientation},
) {
    const tabsTokens = [];
    const tabListTokens = [];
